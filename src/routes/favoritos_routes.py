...
from models.planeta import Planeta, PlanetaFavorito
from models.vehiculo import Vehiculo, VehiculoFavorito
from models.personaje import Personaje, PersonajeFavorito
